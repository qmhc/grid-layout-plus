        ...
        sidebar: [
          ...
          },
          {
            ...
            items: [
              ...
              { text: 'Multi-directional Resize Handles', link: '/example/multi-resize-handles' },
        ...
        sidebar: [
          ...
          },
          {
            ...
            items: [
              ...
              { text: '多方向缩放手柄', link: '/zh/example/multi-resize-handles' },
              { text: '拖拽阈值', link: '/zh/example/drag-threshold' },
              { text: '原生拖放', link: '/zh/example/native-drop' },
              { text: '网格背景', link: '/zh/example/grid-background' },
